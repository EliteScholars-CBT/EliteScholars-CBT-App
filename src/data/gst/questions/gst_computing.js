...
export const GST_QB_GST_COMPUTING = [
  ...
  { q: 'The internet protocol that assigns a unique address to every device is:', o: ['HTTP', 'FTP', 'IP', 'SMTP'], a: 2, e: 'IP (Internet Protocol) assigns a unique IP address to every device on a network.', h: 'What gives your device its network identity?', yr: '2022' },
  { q: 'A spreadsheet application is best used for:', o: ['Writing essays', 'Storing images', 'Calculating and analysing data', 'Browsing the internet'], a: 2, e: 'Spreadsheet applications (Excel, Google Sheets) are designed for numerical data, calculations, and analysis.', h: 'Numbers, formulas, charts.', yr: '2021' },
];
