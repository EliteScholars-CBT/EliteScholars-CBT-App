...
export const FREE_SESSION_MINUTES = 240;  // max CBT/learn time per session (minutes)
export const FREE_COOLDOWN_HOURS  = 1;   // hours before they can continue after limit
