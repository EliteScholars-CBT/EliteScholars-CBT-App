...
// ── Report card email ─────────────────────────────────────────────────────────
function buildReportEmail({ wardName, guardianEmail, stats, subjectPerformance, achievements, weekFrom, weekTo, plan }) {
    ...
    <table width="100%" style="max-width:580px;background:#1a1a2e;border-radius:16px;overflow:hidden;border:1px solid #2a2a4a;">
      ...
      <tr>
        <td style="padding:28px 32px 0;">
          <p style="margin:0 0 6px;color:#c8c8c8;font-size:14px;line-height:1.7;">
            Dear Guardian,
          </p>
      ...
      <tr>
        <td style="padding:0 32px 28px;">
          <div style="background:rgba(75,0,130,0.2);border:1px solid rgba(75,0,130,0.4);border-radius:10px;padding:16px 20px;">
            <div style="font-size:12px;font-weight:700;color:#c8b4f0;margin-bottom:8px;">
              📝 Progress Note
            </div>
      ...
      <tr>
        <td style="padding:0 32px 28px;">
          <p style="margin:0;color:#5a5a7a;font-size:11px;line-height:1.7;">
            This report is generated automatically every Sunday for <strong style="color:#9090b0;">${wardName}</strong>'s 
